...
if __name__ == '__main__':
    ...
    '''
    key_params = {'min-grad': 15, 'ffl-block': 120, 'min-ele-area': 200,
                  'merge-contained-ele': True, 'merge-line-to-paragraph': True, 'remove-bar': True,
                  "max-word-inline-gap": 100, "max-line-gap": 100}

    # set input image path
    input_path_img = '/Users/pkamra/IdeaProjects/drizz_test/ios_screenshot.png'
    output_root = 'output'
